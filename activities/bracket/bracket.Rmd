...
Choose any possible tournament outcome.
Try to choose a different bracket than everybody else. 
...
- How would your score change if the scoring was different, e.g. round times seed?
- How can we compute the bracket that will maximize the expected score especially if the scoring is complicated?
